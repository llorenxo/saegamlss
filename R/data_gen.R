...
#' @param Dis Type of distribution in form of rDis where Dis is one of the distribution allowed by GAMLSS. It is to be defined to use distribution different from the normal one
...
#' #
#' data_gen(
#'   Ni = rep(10, 4), D = 4, M = 2, ty = "het", k = 100, b1 = 4,
#'   x1 = rnorm(40, 0, 1), b2 = NULL, x2 = NULL, b3 = NULL,
...
#' #
#' data_gen(
#'   Ni = rep(10, 4), D = 4, M = 2, ty = NULL, k = c(7, -2), b1 = 1,
